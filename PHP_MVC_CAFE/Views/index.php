        ...
        <div class="container-fruid" >
            ...
            <div class="row menu scroll-block fade-block1">
                ...
                <div class="col-md-6 col-xs-12 right">
                    <div class="box-right">サーモンは刺身やカルパッチョで食べるのが美味しいが、ステーキにするのもおすすめだ。和食の焼鮭とは一味違う、
                        リッチな気分になれるサーモンステーキの作り方をマスターしよう。サーモンの美味しさを引き立てる2種のソースも併せて紹介する。
            ...
            <div class="row menu scroll-block fade-block1">
                ...
                <div class="col-md-6 col-xs-12 right">
                    <div class="box">
                    <div class="box-right">最もおいしいとされるコーヒー豆を世界中から買い付けています。
                        そして、そのコーヒー豆が持つ個性を最大限に引き出すべく、コーヒー豆の種類に応じたレシピを使用して自社のロースタリーで焙煎しています。</div>
                    </div>
                </div>
            </div>
            <div class="row menu scroll-block fade-block1">
                ...
                <div class="col-md-6 col-xs-12 right">
                    <div class="box-right">まず何よりも大切なのが衛生管理です。「安全・安心」をお届けする事が大前提ですので、
                        それを守り続けるためには日々継続的な努力と改善が求められます。</div>
                </div>
            </div>
